    ...
    <div className="bg-neutral-800 rounded-lg p-2">
      <ul className="space-y-4">
        <li>
          <a
            href="#"
            className="flex items-center gap-4 text-white font-bold hover:text-white transition-colors duration-300"
          >
        ...
        <li>
          <a
            href="#"
            className="flex items-center gap-4 hover:text-white transition-colors duration-300 font-semibold"
          >
      ...
      <div className="overflow-y-auto px-2">
        {playlists.map((playlist, index) => (
          <a
            key={index}
            href="#"
            className="flex items-center gap-3 p-2 rounded hover:bg-neutral-700 transition-colors duration-300"
          >
      ...
      <table className="w-full text-left text-neutral-400">
        ...
        <tbody>
          {songs.map((song) => (
            <tr
              key={song.id}
              className="group hover:bg-neutral-700/50 rounded-lg"
            >
...
// ===================================================================================
// KOMPONEN PLAYER BAR (PEMUTAR MUSIK)
// ===================================================================================
